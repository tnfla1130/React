...
//css 파일을 추가하는 경우 src하위에 생성한 후 import해서 적용한다. 
import '../Chat.css';
...
function ChatMessage(){
   ...
   */
  //리스너는 감시자 역할의 함수로 어떤 일이 생기면 알려줘! 하고 기다리는 함수
  ...
  useEffect(()=>{
    ...
    onValue(dbRef, (snapshot)=>{
      ...
      //onValue가 작동한 0.1초 후에 스크롤바를 내리는 함수를 강제실행.
      setTimeout(()=>{
      ...
      snapshot.forEach((childSnapshot)=>{
        ...
        // console.log(childKey,childData.id,userId);
